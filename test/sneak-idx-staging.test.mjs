...
describe('SNEAK IDX Phase 2.2 Test Suite', () => {
    ...
    test('PHASE 7.4B2: Serving and frontend build versions are uniformly bumped to 2026.09.25.2', () => {
        ...
        assert.ok(searchHtml.includes('data-ui-build="2026.09.25.2"'), 'search/index.html must have data-ui-build="2026.09.25.2"');
        assert.ok(searchHtml.includes("CCOR_IDX_UI_BUILD = '2026.09.25.2'"), "search/index.html must have CCOR_IDX_UI_BUILD = '2026.09.25.2'");
        assert.ok(embedJs.includes("const buildVersion = '2026.09.25.2'"), "embed.js must have buildVersion = '2026.09.25.2'");
        assert.ok(servingWorker.includes("SNEAK_IDX_BUILD = '2026.09.25.2'"), 'SneakIDXWorker.js must expose the 7.4B2 build');
