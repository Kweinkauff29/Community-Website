...
describe('SNEAK IDX Phase 2.2 Test Suite', () => {
    ...
    test('PHASE 7.3C2A.1: Frontend build versions are uniformly bumped to 2026.08.30.7.3c2a1', () => {
        ...
        assert.ok(searchHtml.includes('data-ui-build="2026.08.30.7.3c2a1"'), 'search/index.html must have data-ui-build="2026.08.30.7.3c2a1"');
        assert.ok(searchHtml.includes("CCOR_IDX_UI_BUILD = '2026.08.30.7.3c2a1'"), "search/index.html must have CCOR_IDX_UI_BUILD = '2026.08.30.7.3c2a1'");
        assert.ok(embedJs.includes("const buildVersion = '2026.08.30.7.3c2a1'"), "embed.js must have buildVersion = '2026.08.30.7.3c2a1'");
